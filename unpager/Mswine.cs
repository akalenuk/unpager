...
namespace WindowsFormsApplication1 {
    class Mswine {
        ...
        */
        double F_s(double[] dot, double[][] xyz, int[][] Sx, BasisFunction[] base_f, WeightFunction s_k) {
            int DIMM = dot.Length;
        ...
        */
        double F_sex(double[] dot, double[][] xyz, int[][] Sx, BasisFunction[] base_f, WeightFunction s_k) {
            ...
            int[] pnt_set = new int[best_pack.vec2.Length];
            for(int i = 0; i < best_pack.vec2.Length; i++){
                pnt_set[i] = best_pack.vec2[i] - 1;
            }
            return get_inS(dot,best_pack.vec1,pnt_set, xyz,Sx,base_f,s_k);
        }
        ...
        */
        double get_inS(double[] dot, double[] prj, int[] pnt_set, double[][] xyz, int[][] Sx, BasisFunction[] base_f, WeightFunction s_k) {
